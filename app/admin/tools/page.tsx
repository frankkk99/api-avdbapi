...
const tools = [["/admin/player", "HLS Test", "ตรวจ Manifest, CORS, expiry และ Segment"], ["/admin/avdb-import-test", "AVDB Import", "ดึงข้อมูลจากหน้า AVDB ตาม flow เดิม"], ["/admin/bulk-player-test", "Bulk Player Test", "ค้นหาและทดสอบหลายเรื่อง"], ["/admin/player-extractor", "Player Extractor", "ตรวจแหล่ง HLS / MP4"], ["/admin/embed-test", "Embed Test", "ทดสอบการครอบ Player"]] as const;
